...
def process_user_creation(create_clicks, close_clicks, username_from_ui, first_name, last_name, email):
    ...
    if 'create-button' in ctx.triggered_id:
        ...
        # TODO: how do we handle duplicate usernames? does the htpasswd CLI handle this natively?
        
        create_user_in_cluster(username_from_ui, autogenerated_user_password)
        ...
        ocp_cluster_url = # TODO: get the ocp cluster url from the cluster
...
def create_user_in_cluster(username_from_ui, autogenerated_user_password):
    # TODO: configure an htpasswd identity provider in the cluster, per these instructions: 
        # https://docs.openshift.com/container-platform/4.8/authentication/identity_providers/configuring-htpasswd-identity-provider.html#identity-provider-creating-htpasswd-secret_configuring-htpasswd-identity-provider
